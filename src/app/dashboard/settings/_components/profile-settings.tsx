                ...
                {isUserLoading ? (
                    ...
                    <>
                        <Dialog open={isAvatarDialogOpen} onOpenChange={setIsAvatarDialogOpen}>
                            ...
                            <DialogContent aria-describedby="avatar-dialog-description">
                                <DialogHeader>
                                    <DialogTitle>Profilbild auswählen</DialogTitle>
                                    <DialogDescription id="avatar-dialog-description">Wähle einen neuen Avatar aus der Liste aus.</DialogDescription>
                                </DialogHeader>
